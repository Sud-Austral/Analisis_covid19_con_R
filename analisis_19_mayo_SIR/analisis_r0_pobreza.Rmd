...
covid19_sin_title_com <-
  read_xlsx(
    "C:/Users/usuario/Documents/GitHub/Analisis_covid19_con_R/SIR_19_mayo_graficas/covid19_sin_title_com.xlsx"
  )
```
...
covid19 <-
  read_xlsx(
    "C:/Users/usuario/Documents/GitHub/Analisis_covid19_con_R/SIR_19_mayo_graficas/covid19cccc.xlsx"
  )
...
# Default plot
plot(hc, hang = -1, cex = 0.3, labels = covid19_sin_title_com$com)
```
...
```{r, echo=FALSE, fig.width=10, fig.height=10}
# zoom al dendrograma:
hcd <- as.dendrogram(hc, labels = covid19_sin_title_com$com)
hcd  %>% set("labels", covid19_sin_title_com$com) -> hcd
hcd  %>% set("labels_cex", 0.5) -> hcd
plot(hcd, xlim = c(10, 90), ylim = c(10,100), horiz = TRUE)
```
...
ggscatter(covid19, x = "r0", y = "Pobreza", 
          add = "reg.line", conf.int = TRUE, 
          cor.coef = TRUE, cor.method = "pearson",
          xlab = "r0", ylab = "Pobreza")

res <- cor.test(covid19$r0, covid19$Pobreza, 
                    method = "pearson")
res
...
covid19.normalizado<- scale(covid19[,c(2,3)],center=T,scale=T)
kable(head(covid19.normalizado,10),format = "markdown")
